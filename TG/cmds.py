...
HELP_MSG = """
<b>To download a manga just type the name of the anime you want to keep up to date.</b>
...
async def start(client, message):
	...
	await message.reply_photo(
		photo,
		caption=
		("<b><i>Welcome to the anime bot in telegram!!</i></b>\n"
			 "\n"
			 "<b><i>How to use? Just type the name of anime you want to keep up to date.</i></b>\n"
			 "\n"
			 "<b><i>For example:</i></b>\n"
...
@Bot.on_message(
		filters.command(["pbroadcast", "pb"]) & filters.user(Vars.ADMINS))
